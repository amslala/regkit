...
**regtools** aims to facilitate the manipulation, analysis and
...
registers in Norway can use **regtools** to streamline their initial
...
This vignette introduces **regtools**’s main functions and shows
examples of how to use them with individual-level data. The package also
includes some helper functions that can aid researchers working with
registry data in Norway address specific problems, more information in
the
[`vignette("h-functions")`](https://amslala.github.io/regtools/articles/h-functions.md)
and
[`vignette("other-useful-fun")`](https://amslala.github.io/regtools/articles/other-useful-fun.md).
...
[`?diag_df`](https://amslala.github.io/regtools/reference/diag_df.md)
...
[`?var_df`](https://amslala.github.io/regtools/reference/var_df.md)
...
[`?invar_df`](https://amslala.github.io/regtools/reference/invar_df.md)
...
simulating datasets in `regtools`.
...
and
[`read_admin_data()`](https://amslala.github.io/regtools/reference/read_admin_data.md)
...
recommended for large and larger-than-memory data within **regtools**.
The vignette also includes general instructions on how to write/save
parquet datasets.
...
and
[`filter_admin_data()`](https://amslala.github.io/regtools/reference/filter_admin_data.md)
...
[`curate_diag_data()`](https://amslala.github.io/regtools/reference/curate_diag_data.md)
...
them. In the **regtools** workflow, linkage using the individuals’
unique personal identifiers present in each dataset comes after
filtering, to save on memory and reduce the potential for merging
errors.
...
The
[`link_diag_admin()`](https://amslala.github.io/regtools/reference/link_diag_admin.md)
...
incidence and prevalence rates. Consequently, **regtools** includes the
functions
[`calculate_prevalence()`](https://amslala.github.io/regtools/reference/calculate_prevalence.md)
and
[`calculate_incidence()`](https://amslala.github.io/regtools/reference/calculate_incidence.md)
...
depending on each research question and desired analyses, **regtools**
...
purpose, the
[`calculate_prevalence_series()`](https://amslala.github.io/regtools/reference/calculate_prevalence_series.md)
can compute prevalence rates for a time series. The
[`calculate_incidence_series()`](https://amslala.github.io/regtools/reference/calculate_incidence_series.md)
...
[`plot_rates()`](https://amslala.github.io/regtools/reference/plot_rates.md)
...
![](regtools_files/figure-html/plot-rates-1.png)
...
![](regtools_files/figure-html/unnamed-chunk-3-1.png)

## Logging

To facilitate reproducibility and transparency across research projects,
the majority of functions in **regtools** create log files that document
...
In addition to the main functions in the **regtools** workflow, the
