...
- [`read_admin_data()`](https://amslala.github.io/regkit/reference/read_admin_data.md)
  : Read and validate the structure of administrative (sociodemographic)
  individual-level data
- [`filter_diag_data()`](https://amslala.github.io/regkit/reference/filter_diag_data.md)
  : Validate and filter diagnostic data by selected ICD-10 or ICPC-2
  codes
...
- [`harmonize_municipality_codes()`](https://amslala.github.io/regkit/reference/harmonize_municipality_codes.md)
  : Harmonize old municipality codes in Norway to 2024 municipality
  codes

## Example datasets

- [`diag_df`](https://amslala.github.io/regkit/reference/diag_df.md) :
  Example diagnostic individual-level data
...
- [`var_df`](https://amslala.github.io/regkit/reference/var_df.md) :
  Example time-variant individual-level data
- [`linked_df`](https://amslala.github.io/regkit/reference/linked_df.md)
  : Example linked individual-level data
- [`kommuner_2016`](https://amslala.github.io/regkit/reference/kommuner_2016.md)
  : Norwegian municipalities valid in 2016
